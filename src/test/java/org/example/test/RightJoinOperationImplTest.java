...
class RightJoinOperationImplTest {
    ...
    void join() {
        ...
        JoinOperation<DataRow<Integer, String>, DataRow<Integer, String>, JoinedDataRow<Integer, String, String>> joinOperation = new RightJoinOperationImpl<>();
        ...
        assertThat(join.toString(),
                Is.is("[JoinedDataRow(0, Ukraine, Kyiv), JoinedDataRow(1, Germany, Berlin), JoinedDataRow(3, null, Budapest)]"));
    }
